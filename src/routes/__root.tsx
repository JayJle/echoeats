...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dinner Where — AI Restaurant Discovery Agent" },
      { name: "description", content: "用自然语言描述需求，AI 跨平台找到最适合你的餐厅。" },
      { name: "author", content: "Echo Eats" },
      { property: "og:title", content: "Dinner Where — AI Restaurant Discovery Agent" },
      { property: "og:description", content: "用自然语言描述需求，AI 跨平台找到最适合你的餐厅。" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Dinner Where — AI Restaurant Discovery Agent" },
      { name: "twitter:description", content: "用自然语言描述需求，AI 跨平台找到最适合你的餐厅。" },
